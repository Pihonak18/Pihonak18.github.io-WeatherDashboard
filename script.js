function searchCity(cityname) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=bf8932357f02763cfdaf46419d18987f";
    var queryURLforcast = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityname + "&units=imperial&appid=bf8932357f02763cfdaf46419d18987f";
$.ajax({
    url: queryURL,
    method: 'GET'
    ...
    var queryURLUV = "https://api.openweathermap.org/data/2.5/uvi?&appid=bf8932357f02763cfdaf46419d18987f&lat=" + lat  + "&lon=" + lon;
$.ajax({
        url: queryURLUV,
        method: 'GET'
}).then(function (response) {
